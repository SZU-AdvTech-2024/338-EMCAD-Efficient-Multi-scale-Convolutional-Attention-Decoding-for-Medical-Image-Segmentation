...
def inference(args, model, best_performance):
    db_test = ACDCdataset(base_dir=args.volume_path, split="test_vol", list_dir=args.list_dir)
...
def trainer_ACDC(args, model, snapshot_path):
    ...
    db_train = ACDCdataset(base_dir=args.root_path, list_dir=args.list_dir, split="train", nclass=args.num_classes,
